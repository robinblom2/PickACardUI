...
namespace PickACardUI
{
    class CardPicker
    {
        ...
        public static string[] PickSomeCards(int numberOfCards)                 // This method will generate a string array and then fill that string array with values from the two other methods RandomValue() and RandomSuit().  
        {
            ...
            return pickedCards;                                                 // After all of the cards have been randomly generated by the two other methods, this method returns the array to the Button_Click-method in the MainWindow-class,  where they get added in a ListBox.
        }
